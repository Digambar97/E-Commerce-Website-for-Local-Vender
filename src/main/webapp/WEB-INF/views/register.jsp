...
<div class="container mx-auto px-4 py-20">
    <div class="max-w-lg mx-auto bg-white p-10 rounded-[2.5rem] shadow-2xl">
        ...
        <h2 class="text-3xl font-black mb-8 text-gray-900 text-center">Create Account</h2>

        <form action="/registerUser" method="post" class="flex flex-col gap-6">
